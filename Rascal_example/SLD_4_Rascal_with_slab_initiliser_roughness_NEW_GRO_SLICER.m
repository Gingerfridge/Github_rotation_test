function [output] = SLD_4_Rascal_with_slab_initiliser_roughness_NEW_GRO_SLICER(params,bulk_in,bulk_out,contrast)
...
if surface_switch == 1
    [xx,yy] = SLD_sim_and_slab_NEW_GRO(params,bulk_in,bulk_out,contrast,surface_switch)    
...
%only simulation SLD
    ...
    [xx,yy] = Rascal_XY_maker_slab_initiliser_NEW_GRO(params,bulk_in,bulk_out,contrast,starting_params_number); %%% This part adds the sliced SLD
