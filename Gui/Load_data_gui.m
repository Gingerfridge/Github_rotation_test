...
% Last Modified by GUIDE v2.5 10-Nov-2021 13:54:32
...
set(handles.Load_gro_file_pushbutton1, 'visible','off')
...
if handles.Rotation_checkbox2.Value
    ...
    set(handles.pushbutton9, 'visible','off')
    set(handles.Load_gro_file_pushbutton1, 'visible','on')
...
if ~handles.Rotation_checkbox2.Value
    handles.text2.String = {'Tick the Rotation or Simulation box to use this function'};
...
Simulation_checkbox4 = get(hObject,'Value');
if handles.checkbox4.Value
    handles.text2.String = {'This fuction takes a simulation and output gro files used to output the SLD profiles for fitting in matlab etc.'};
    set(handles.Rotation_checkbox2,'Enable','off')
    ...
    % add logic to change the load file boxes
...
% If Checkbox B is selected, then the dropdown options would be A,B,C
if ~handles.checkbox4.Value
        set(handles.Rotation_checkbox2,'Enable','on')
        handles.text2.String = {'Tick the Rotation or Simulation box to use this function'};
        set(handles.pushbutton9, 'visible','off')
        set(handles.Load_gro_file_pushbutton1, 'visible','off')
        set(handles.text6, 'visible','off')
